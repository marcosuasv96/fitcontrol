...
// DEFINICIÓN DE TIPOS FORMALES ADAPTADOS SIN INPUTS DE EJECUCIÓN (LÍNEAS CORREGIDAS)
    ...
    <div className="space-y-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col justify-between min-h-[140px]">
          ...
          <span className="text-[10px] text-emerald-600 font-bold block">● Servidores en producción</span>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col justify-between min-h-[140px]">
          <div>
            ...
            <p className="text-3xl font-black text-[#232529] mt-3 font-mono">${loading ? '...' : ingresoEstimated.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <span className="text-xs text-slate-400 font-bold font-sans">MXN</span></p>
          </div>
